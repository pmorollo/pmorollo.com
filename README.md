...
- A imagem principal preserva a proporção 3:2 nos diferentes tamanhos de tela, sem cortar a composição.
...
- **Método Página Virada v3.0**: cópia física e versionada da skill em `.opencode/skills/pagina-virada/SKILL.md` (três etapas centrais + leitura simbólica opcional). Este arquivo integra o repositório e deve ser incluído no Back Mestre.
